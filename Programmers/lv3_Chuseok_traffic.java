...
public class lv3_Chuseok_traffic {
    public static void main(String[] args) throws Exception {
        String[] lines = {"2016-09-15 01:00:04.002 2.0s", "2016-09-15 01:00:07.000 2s"};
        Solution_chuseok_traffic ct = new Solution_chuseok_traffic();
        System.out.println(ct.solution(lines));
    }
}

class Solution_chuseok_traffic {
