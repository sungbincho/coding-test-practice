// 프로그래머스 lv2_행렬_테두리_회전하기

package Programmers;

import java.util.*;

public class lv2_Matrix_rotation {
    public static void main(String[] args) {
        int rows = 6;
        int columns = 6;
        int[][] queries = {{2, 2, 5, 4}, {3, 3, 6, 6}, {5, 1, 6, 3}};
        Solution_matrix_rotation mr = new Solution_matrix_rotation();
        System.out.println(Arrays.toString(mr.solution(rows, columns, queries)));
    }
}

class Solution_matrix_rotation {
